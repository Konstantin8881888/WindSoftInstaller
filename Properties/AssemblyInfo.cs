...
// GenerateAssemblyInfo=false также отключает авто-генерацию InternalsVisibleTo из
// тега <InternalsVisibleTo/> в csproj — поэтому объявляем его явно для тестового проекта.
[assembly: InternalsVisibleTo("WindSoftInstaller.Tests")]
