...
- 🖥️ **Ярлыки** – создаются на рабочем столе для каждого установленного приложения (если поддерживается).
...
1. **Собрать из исходников** – следуя инструкции в разделе «Сборка из исходников» выше.
...
- По окончании установки каждого приложения его временные файлы удаляются, а на рабочем столе создаётся ярлык.
...
## Структура проекта (кратко)
    ...
    │   ├── ShortcutService.cs       # Создание ярлыков
    ...
    ├── ShortcutHelper.cs            # Вспомогательные методы для ярлыков
